    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.location_on, color: _primaryPink, size: 22),
