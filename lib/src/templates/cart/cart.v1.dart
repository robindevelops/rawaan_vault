...
/// Cart v1 - Modern Minimal Cart Screen
/// A clean, minimalistic design with elegant typography and subtle shadows
...
class _CartV1ScreenState extends State<CartV1Screen> {
  ...
  static const Color _accent = Color(0xFF4A90A4);
  static const Color _textPrimary = Color(0xFF1A1A2E);
  static const Color _textSecondary = Color(0xFF7A7A8C);
  ...
  double get _shipping => _subtotal > 500 ? 0 : 15.99;
  ...
  Widget _buildCartItemsList() {
    return Column(
      children: _cartItems.asMap().entries.map((entry) {
        ...
        return _buildCartItem(item, entry.key);
      }).toList(),
    );
  }
  ...
  Widget _buildPromoCode() {
    return Container(
      ...
      child: Row(
        children: [
          const SizedBox(width: 16),
          Icon(Icons.discount_outlined, color: _textSecondary, size: 22),
