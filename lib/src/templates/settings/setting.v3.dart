...
/// Settings v4 - Warm Coral Accent Theme
/// Elegant dark theme with refined coral/peach accent colors
class SettingV3Screen extends StatefulWidget {
  const SettingV3Screen({super.key});

  @override
  State<SettingV3Screen> createState() => _SettingV3ScreenState();
}

class _SettingV3ScreenState extends State<SettingV3Screen> {
  ...
  static const Color _textSec = Color(0xFF9A9AB0);
