...
/// Cart v5 - Slate Blue Cart Screen
/// Professional design with modern slate blue tones
class CartV5Screen extends StatefulWidget {
  const CartV5Screen({super.key});

  @override
  State<CartV5Screen> createState() => _CartV5ScreenState();
}

class _CartV5ScreenState extends State<CartV5Screen> {
  static const Color _bg = Color(0xFFF4F6F9);
  static const Color _card = Color(0xFFFFFFFF);
  static const Color _primary = Color(0xFF3B4C6B);
  static const Color _accent = Color(0xFF6B8EAE);
  static const Color _textPrimary = Color(0xFF2C3E50);
  static const Color _textSecondary = Color(0xFF919EAB);
  ...
  double get _shipping => _subtotal > 500 ? 0 : 24.99;
  ...
  Widget _buildPromoCode() {
    return Container(
      ...
      child: Row(
        children: [
          const SizedBox(width: 16),
          Icon(Icons.sell_outlined, color: _textSecondary, size: 22),
