...
/// Cart v3 - Navy Elegant Cart Screen
/// Professional design with deep navy and coral accents
class CartV3Screen extends StatefulWidget {
  const CartV3Screen({super.key});

  @override
  State<CartV3Screen> createState() => _CartV3ScreenState();
}

class _CartV3ScreenState extends State<CartV3Screen> {
  static const Color _bg = Color(0xFFF5F7FA);
  static const Color _card = Color(0xFFFFFFFF);
  static const Color _primary = Color(0xFF1E3A5F);
  static const Color _accent = Color(0xFFE07B67);
  ...
  double get _shipping => _subtotal > 400 ? 0 : 19.99;
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${_cartItems.length} items in bag',
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.local_offer_outlined, size: 16, color: _accent),
  ...
  Widget _buildPromoCode() {
    return Container(
      ...
      child: Row(
        children: [
          const SizedBox(width: 16),
          Icon(Icons.percent, color: _textSecondary, size: 22),
